...
class HandDetector():
    def __init__(self, mode=False, maxHands=1, modelComplexity =1, detectConfi=0.5, trackConfi=0.5):
        ...
        self.hands = self.mpHands.Hands(self.mode, self.maxHands,self.modelComplexity, self.detectConfi, self.trackConfi)
